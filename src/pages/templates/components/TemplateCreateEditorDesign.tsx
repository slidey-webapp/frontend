...
const TemplateCreateEditorDesign: React.FC<Props> = () => {
    const { currentSlideId, slides, onUpdatePresentation, setHoverState } = useTemplateCreateContext();
...
export default TemplateCreateEditorDesign;
